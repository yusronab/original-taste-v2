...
const aboutData = [
  ...
  },
  {
    ...
    info: [
      {
        title: 'Unesa Web Developmnet - Participant',
        stage: '2022 - 2022',
      },
      {
        title: 'Infosary UI/UX Design Competition - Finalist',
        stage: '2022 - 2022',
      },
    ],
  },
  {
    ...
    info: [
      {
        title: 'Independent Study Program - Binar Academy',
        stage: '2022',
      },
    ],
  },
  {
    ...
    info: [
      {
        title: 'Informatics Engineering - Politeknik Harapan Bersama',
        stage: '2020',
      },
      {
      ...
      <div className='container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6'>
        <div className='flex-1 flex flex-col justify-center'>
          <motion.h2
            ...
            className='h2'
          >
            Captivating <span className='text-accent'>stories</span> birth maginificant designs
          </motion.h2>
          <motion.p
          ...
          >
            Familiar with several programming languages and popular framework
          </motion.p>
          <motion.div
